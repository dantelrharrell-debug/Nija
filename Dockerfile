...
RUN python -S /app/scripts/install_sitecustomize_defer_guard.py && \
    ...
    python -S /app/scripts/apply_canonical_launcher_v26.py && \
    python -S /app/scripts/apply_writer_generation_handoff_v45.py && \
    python -S /app/scripts/apply_render_signal_forwarding_v262.py && \
    bash -n /app/start.sh && \
...
RUN NIJA_DEFER_RUNTIME_SITE_HOOKS=1 python -S -m py_compile \
        ...
        /app/bot/bot.py \
        /app/bot/bot_main.py \
        /app/bot/canonical_broker_bootstrap_handoff_patch.py \
        /app/bot/canonical_broker_main_entry_guard_v20.py \
        /app/bot/canonical_broker_prebootstrap_v22.py \
        ...
        /app/scripts/apply_render_signal_forwarding_v262.py \
...
RUN test -f /app/scripts/redis_connectivity_check.sh && \
    ...
    test -f /app/scripts/apply_render_signal_forwarding_v262.py && \
...
CMD ["bash", "scripts/render_entrypoint.sh"]