...
def main() -> None:
    ...
    print(
        ...
        "retry_fail_closed=true orders_submitted=false cost_basis_fabricated=false "
        "readiness_fabricated=false eligibility_fabricated=false safety_gates_bypassed=false"
    )
