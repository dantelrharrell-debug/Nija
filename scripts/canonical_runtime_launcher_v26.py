...
MARKER = "20260727-canonical-runtime-launcher-v26-v34"
...
def install_canonical_startup_guard() -> ModuleType:
    """Install v24, v32, v33, and v34 before any application import."""
    ...
    LOGGER.critical(
        ...
        "v33_installed=true v34_installed=true",
        MARKER,
    )
    return module
...
def main() -> int:
    ...
    print(
        ...
        "marker=20260727-canonical-fast-entrypoint-v34 "
