...
python3 -S scripts/apply_kraken_margin_protection_chain_v386.py
...
python3 -S -m py_compile \
    ...
    scripts/apply_kraken_margin_protection_chain_v386.py \
...
grep -Fq 'AUTHORITATIVE_USER_POSITION_V385_FAIR_REFRESH' bot/runtime_authoritative_position_coverage_v285_patch.py
grep -Fq 'KRAKEN_MARGIN_V368_V371_CHAIN_V386_READY' bot/runtime_kraken_margin_protection_truth_v367_patch.py
...
echo "🧭 RENDER_ENTRYPOINT_CANONICAL_HANDOFF_READY marker=20260907-kraken-margin-protection-chain-v386 launcher=canonical_runtime_launcher_v26 writer_generation_handoff=v45 writer_first=v59 execution_proof_startup_isolation=v339 execution_proof_freshness_truth=v375 activation_publication_fast_path=v376 kraken_coverage_truth_fairness=v385 kraken_margin_protection_chain=v386 signal_forwarding=v262 single_identity=true singleton_alias_convergence=v91 kraken_nonce_authority_gate=v91 direct_broker_prebootstrap=v27 outreach_frontdoor=v3 signed_webhook=true webhook_autoconfig=true campaign_compliance_fail_closed=true"
