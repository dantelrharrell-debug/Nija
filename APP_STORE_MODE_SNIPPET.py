...
def get_reviewer_risk_disclosures() -> Dict[str, Any]:
    ...
    return {
        ...
        'disclosures': {
            'independent_trading': (
                'Each account trades independently using shared software logic with independent per-account evaluation '
                'and account-specific state and execution context. No trade copying occurs.'
            ),
            'risk_warning': (
