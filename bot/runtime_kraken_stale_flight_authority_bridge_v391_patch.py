...
def install() -> bool:
    with _LOCK:
        ...
        LOGGER.critical(
            ...
            "capital_authority_feed_timestamp_required=true freshness_extended=false network_call=false "
...
__all__ = ["MARKER", "install", "install_import_hook", "_authority_observation"]
