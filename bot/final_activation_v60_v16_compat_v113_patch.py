...
The shim now evaluates every existing hard pre-dispatch gate first, then asks the
FSM to converge with gates_ok=True. This does not grant dispatch authority; the
