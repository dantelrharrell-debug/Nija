...
AGGRESSIVE_PROFILE = ModeProfile(
    ...
    description="Maximum trade frequency — lower thresholds, more trades",
    ...
    min_trades_per_hour=2.0,         # increased from 1.5 → 2.0 to match frequency controller default
    min_trades_per_day=20.0,         # increased from 15.0 → 20.0 for more consistent daily activity
    regime_strict=False,
    mtf_required=False,
    emoji="🔥",
)
