...
class AlertType(Enum):
    ...
    # NEW ALERTS - February 8, 2026
    POSITION_CAP_BREACH = "POSITION_CAP_BREACH"
    FORCED_CLEANUP_TRIGGERED = "FORCED_CLEANUP_TRIGGERED"
    KILL_SWITCH_ACTIVATED = "KILL_SWITCH_ACTIVATED"
    EXCHANGE_DESYNC = "EXCHANGE_DESYNC"
    DRAWDOWN_THRESHOLD = "DRAWDOWN_THRESHOLD"
    RECONCILIATION_ISSUE = "RECONCILIATION_ISSUE"
    CAPITAL_RESERVATION_FULL = "CAPITAL_RESERVATION_FULL"
