    ...
    *,
    ...
    if not result.success:
        ...
        if broker_order_id:
            ...
            # Release only when the failure contract proves that no broker
            # submission occurred.  All other no-order-id failures remain
            # uncertain to prevent a blind duplicate retry.
