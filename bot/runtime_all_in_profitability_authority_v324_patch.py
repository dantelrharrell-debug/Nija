...
(v331), JIT reconciliation-conflict recovery (v332), and canonical public
market-price convergence for exits (v333) in the same writer process.
"""
...
def install_import_hook() -> bool:
    ...
    if ready:
        LOGGER.critical(
            "CANONICAL_PROFITABILITY_CHAIN_READY marker=%s v324=true v325=true v326=true v327=true v328=true v329=true v330=true v331=true v332=true v333=true "
            ...
            "short_public_price_cache=true spot_fallback=false confirmed_short_fill_required=true "
