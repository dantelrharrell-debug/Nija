...
def _install_kraken_user_supervision() -> bool:
    ...
    # Keep this inside the existing supervision entrypoint so the build-time
    ...
    try:
        ...
        if installed:
            ...
            installed = bool(v312.install_import_hook())
        if installed:
    ...
    if installed:
        ...
        LOGGER.critical(
            ...
            "authenticated_balance_epoch_handoff=true existing_flight_timeout_recovery=true "
