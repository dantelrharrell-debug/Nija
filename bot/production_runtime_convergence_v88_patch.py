...
def _install_kraken_user_supervision() -> bool:
    ...
    try:
        ...
        if installed:
            ...
            installed = bool(v297.install_import_hook())
        if installed:
            from bot import runtime_kraken_inflight_snapshot_truth_v298_patch as v298
            installed = bool(v298.install_import_hook())
        if installed:
            from bot import runtime_kraken_credential_read_convergence_v299_patch as v299
            installed = bool(v299.install_import_hook())
    ...
    if installed:
        ...
        LOGGER.critical(
            "KRAKEN_USER_SUPERVISION_V88_CHAINED marker=%s source=v86+v90+v266+v282+v285+v286+v287+v288+v289+v290+v292+v293+v294+v295+v296+v297+v298+v299 "
            ...
            "dust_position_policy_converged=true authoritative_monitoring_priority=true "
...
def install_import_hook() -> bool:
    ...
    LOGGER.critical(
        ...
        "kraken_credential_read_convergence_v299=true stale_log_filter=true "
