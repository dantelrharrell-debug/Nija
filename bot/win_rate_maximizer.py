...
# LOOSENED (Apr 2026): Lowered from 55 → 46 → 40 → 34 → 27 (flow-mode) to increase trade frequency.
# 27 is the true activation zone for micro-cap scalping in ranging/normal markets.
...
DEFAULT_SIGNAL_THRESHOLD: float = float(
    os.getenv("NIJA_WMX_SIGNAL_THRESHOLD", os.getenv("WMX_SIGNAL_THRESHOLD", "27"))
)
