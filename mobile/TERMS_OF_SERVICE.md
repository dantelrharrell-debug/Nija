...
By accessing or using the NIJA mobile application (the "App") and trading platform services (the "Services"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use the Services.

## 2. Description of Services

NIJA is an automated cryptocurrency trading platform that:
- Executes trades on your behalf using algorithmic strategies
- Connects to cryptocurrency exchanges via API
- Monitors markets and executes trades automatically
- Provides trading analytics and performance tracking
...
- Comply with all local laws regarding online trading
...
- Use biometric authentication on your device

## 5. API Key Management

### Your Responsibilities
- You are solely responsible for your exchange API keys
- Keep API keys secure and confidential
- Configure API permissions appropriately
- Monitor API key usage regularly

### NIJA's Role
- We encrypt and securely store your API keys
- We only use API keys for authorized trading activities
- We never share your API keys with third parties
- We implement industry-standard security measures

## 6. Trading and Financial Risks
...
- Automated trading algorithms do not guarantee profits
- Market conditions can change rapidly
- Exchange outages or API issues may prevent trading

### No Financial Advice
- NIJA is a software tool, not a financial advisor
- We do not provide investment, financial, or legal advice
- Trading decisions are automated based on algorithms
- You should consult with qualified professionals before trading
- We make no representations about potential returns

### Your Trading Decisions
- You maintain full control over your exchange accounts
- You can disable automated trading at any time
- You set position size limits and risk parameters
- You are responsible for tax reporting and compliance

## 7. Subscription and Fees

### Subscription Tiers
- **Basic**: Limited features and position sizes
- **Pro**: Enhanced features and larger positions
- **Enterprise**: Full features and maximum position sizes
...
- Violate exchange terms of service
- Attempt to reverse engineer the platform
- Share or resell your account access
- Use the Services to harm others or the platform
- Circumvent security measures
- Use the Services with unauthorized exchanges

## 9. Intellectual Property

### Our Rights
- NIJA owns all rights to the App, algorithms, and Services
- "NIJA" name, logo, and trademarks are our property
...
- You grant us license to use data to provide Services
...
- We are not liable for losses due to downtime

### Third-Party Dependencies
- Services depend on cryptocurrency exchanges
...
- You remain responsible for pre-termination activities
...
- We will cease automated trading immediately
...
- Non-infringement
- Accuracy or reliability of Services
...
- Exchange failures or API issues
- Data breaches or security incidents (except gross negligence)
- Indirect, incidental, or consequential damages
- Loss of profits, revenue, or data
- Third-party actions or failures

**MAXIMUM LIABILITY**: Our total liability shall not exceed the fees you paid in the 12 months prior to the claim.

## 14. Indemnification

You agree to indemnify and hold NIJA harmless from:
...
- Report taxes on trading gains/losses
...
- You are responsible for determining if use is legal
...
### Entire Agreement
These Terms constitute the entire agreement between you and NIJA.
...
**Important**: Cryptocurrency trading involves significant risk. Only invest what you can afford to lose. NIJA is a tool to automate your trading strategy, not a guarantee of profits.
