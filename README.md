...
**🚀 New to NIJA?** See the **[Quick Start Guide](QUICK_START.md)** for 5-minute setup!
...
> ⚠️ **Note**: If you see "NOT TRADING (Connection failed or not configured)" for these users in the logs, this is **expected behavior** when Kraken credentials are not configured. The master account will still trade successfully. See [QUICK_START.md](QUICK_START.md#why-you-see-not-trading-for-user-accounts) for details.
