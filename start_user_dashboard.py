...
def print_banner():
    ...
    print("  GET  /users                         - Users dashboard (cards view)")
    print("\nUser Management:")
    print("  GET  /api/users                     - List all users")
    print("  GET  /api/users?include_master=true - List all users including master")
    print("  GET  /api/user/{user_id}/pnl        - Get user PnL dashboard")
    print("  GET  /api/master/pnl                - Get master account PnL")
